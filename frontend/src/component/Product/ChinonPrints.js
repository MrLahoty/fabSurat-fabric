...
const ChinonPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Chinon Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Chinon Prints", // Directly filter by "Chinon Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Chinon Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingsss">Chinon Prints</h2>
