...
const Hakoba = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Hakoba" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Hakoba", // Directly filter by "Hakoba" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Hakoba PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingsss">Hakoba</h2>
