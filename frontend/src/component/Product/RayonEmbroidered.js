...
const RayonEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Rayon Embroidery", sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Rayon Embroidery", // Directly filter by "Rayon Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Rayon EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productHeadingsss">Rayon Embroidery</h2>
...
export default RayonEmbroidered;
