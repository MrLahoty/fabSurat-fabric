...
import "./JacquardPositionPrints.css";

const JacquardPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Jacquard Position Prints",  // Directly filter by "Jacquard Position Prints",sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Jacquard Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsssHeadingsss">Jacquard Position Prints</h2>
...
export default JacquardPositionPrints;
