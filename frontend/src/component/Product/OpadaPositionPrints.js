...
const OpadaPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Opada Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Opada Position Prints", // Directly filter by "Opada Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Opada Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Opada Position Prints</h2>
...
export default OpadaPositionPrints;
