...
const GeorgettePrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Georgette Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Georgette Prints", // Directly filter by "Georgette Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Georgette Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssHeadingsss">Georgette Prints</h2>
...
export default GeorgettePrints;
