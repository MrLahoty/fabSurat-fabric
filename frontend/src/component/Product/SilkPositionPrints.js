...
import "./SilkPositionPrints.css";

const SilkPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Silk Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Silk Position Prints", // Directly filter by "Silk Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Silk Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadi">Silk Position Prints</h2>
...
export default SilkPositionPrints;
