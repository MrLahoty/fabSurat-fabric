...
import "./CottonFabric.css";

const CottonFabric = ({ match }) => {
  ...
  const cottonfabricSubSubCategories = 
  [
     "Unstitched Combo",
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        committedPrice,
        "Fabric",
        "Cotton Fabric", // The main category is set to Cotton Fabric
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Cotton Fabric PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingssss">Cotton Fabric</h2>
            ...
            <div className="subCategory-container">
              ...
              {/* Sub-category List */}
              <ul className={`categoryBoxyyyy ${subCategoriesVisible ? "show" : "hide"}`}>
                {cottonfabricSubSubCategories.map((subCategory) => (
                  <li
