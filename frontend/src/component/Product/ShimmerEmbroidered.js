...
const ShimmerEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Shimmer Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Shimmer Embroidery",// Directly filter by "Shimmer Embroidery" sub-sub-category
        committedRatings
      )
    );
...
export default ShimmerEmbroidered;
