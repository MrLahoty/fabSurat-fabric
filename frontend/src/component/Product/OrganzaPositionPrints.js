...
const OrganzaPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Organza Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Organza Position Prints", // Directly filter by "Organza Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Organza Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Organza Position Prints</h2>
...
export default OrganzaPositionPrints;
