...
const MuslinPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Muslin Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Muslin Position Prints", // Directly filter by "Muslin Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Muslin Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Muslin Position Prints</h2>
...
export default MuslinPositionPrints;
