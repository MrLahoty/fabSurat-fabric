...
import "./DyeableCottonEmbroidery.css";

const DyeableCottonEmbroidery = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only  "Chinon Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Cotton Fabric", // Sub-category remains "Cotton Fabric"
        "Dyeable Cotton Embroidery", // Directly filter by  "Dyeable Cotton Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Dyeable Cotton Embroidery PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingoooo">Dyeable Cotton Embroidery</h2>
...
export default DyeableCottonEmbroidery;
