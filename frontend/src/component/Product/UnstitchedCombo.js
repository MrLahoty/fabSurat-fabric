  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Unstitched Combo", // Directly filter by  "Unstitched Combo" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Unstitched Combo Cotton Fabric PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Unstitched Combo</h2>
...
export default UnstitchedCombo;
