...
import "./HakobaPrints.css";

const HakobaPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Hakoba Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Hakoba Prints", // Directly filter by "Hakoba Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Hakoba Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssssssHeadingsss">Hakoba Prints</h2>
