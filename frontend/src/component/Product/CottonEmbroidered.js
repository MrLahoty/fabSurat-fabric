...
import "./CottonEmbroidered.css";

const CottonEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Cotton Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Cotton Embroidery",// Directly filter by "Cotton Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Cotton EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="produHeadingsss">Cotton Embroidery</h2>
...
export default CottonEmbroidered;
