...
import "./ChanderiPositionPrints.css";

const ChanderiPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Jacquard Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Chanderi Position Prints",  // Directly filter by "Chanderi Position Prints",sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Chanderi Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsssHeadingsss">Chanderi Position Prints</h2>
...
export default ChanderiPositionPrints;
