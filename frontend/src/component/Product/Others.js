...
const Others = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Semi Pure" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Others", // Directly filter by  "Others" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Others -- FABSURAT" />
          <div className="productss">
            <h2 className="produHeadingsss">Others</h2>
