...
import "./HakobaFabric.css";

const HakobaFabric = ({ match }) => {
  ...
  const hakobafabricSubSubCategories = 
  [
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        committedPrice,
        "Fabric",
        "Hakoba Fabric", // The main category is set to Hakoba Fabric
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Hakoba Fabric PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingssss">Hakoba Fabric</h2>
            ...
            <div className="subCategory-container">
              ...
              {/* Sub-category List */}
              <ul className={`categoryBoxzzzz ${subCategoriesVisible ? "show" : "hide"}`}>
                {hakobafabricSubSubCategories.map((subCategory) => (
                  <li
