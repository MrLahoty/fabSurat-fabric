...
const VelvetPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Velvet Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Velvet Prints", // Directly filter by  "Velvet Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Velvet Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssssssHeadingsss">Velvet Prints</h2>
