...
import "./SpaceSilkEmbroidery.css";

const SpaceSilkEmbroidery = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Space Silk Embroidery",  // Directly filter by "Space Silk Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Space Silk EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssssHeadingsss">Space Silk Embroidery</h2>
...
export default SpaceSilkEmbroidery;
