...
const ChinonPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Chinon Position Prints", // Directly filter by  "Chinon Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Chinon Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Chinon Position Prints</h2>
...
export default ChinonPositionPrints;
