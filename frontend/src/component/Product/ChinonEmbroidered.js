...
import "./ChinonEmbroidered.css";

const ChinonEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Chinon Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Chinon Embroidery", // Directly filter by "Chinon Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="CHINON EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsssssHeadingsss">Chinon Embroidery</h2>
...
export default ChinonEmbroidered;
