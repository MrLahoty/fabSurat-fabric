...
const OrganzaEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Organza Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Organza Embroidery",  // Directly filter by "Organza Embroidery" sub-sub-category
        committedRatings
      )
    );
...
export default OrganzaEmbroidered;
