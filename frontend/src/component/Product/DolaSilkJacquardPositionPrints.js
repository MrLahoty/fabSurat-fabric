...
import "./DolaSilkJacquardPositionPrints.css";

const DolaSilkJacquardPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Dola Silk Jacquard Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Position Prints", // Sub-category remains "Position Prints"
        "Dola Silk Jacquard Position Prints",  // Directly filter by "Dola Silk Jacquard Position Prints",sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Dola Silk Jacquard Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsssHeadingsss">Dola Silk Jacquard Position Prints</h2>
...
export default DolaSilkJacquardPositionPrints;
