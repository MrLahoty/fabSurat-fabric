...
const TissueZariPositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only  "Tissue Zari Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Tissue Zari Position Prints", // Directly filter by "Tissue Zari Position Prints" sub-sub-category
        committedRatings
      )
    );
...
export default TissueZariPositionPrints;
