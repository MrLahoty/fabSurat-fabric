...
const SugarcanePrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Sugarcane Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Sugarcane Prints", // Directly filter by "Sugarcane Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Sugarcane Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssssHeadingsss">Sugarcane Prints</h2>
...
export default SugarcanePrints;
