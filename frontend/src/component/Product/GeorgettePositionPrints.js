...
import "./MuslinPositionPrints.css";

const GeorgettePositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Georgette Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Georgette Position Prints", // Directly filter by "Georgette Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Georgette Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Georgette Position Prints</h2>
...
export default GeorgettePositionPrints;
