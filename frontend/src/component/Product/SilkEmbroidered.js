...
const SilkEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Silk Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Silk Embroidery",  // Directly filter by "Silk Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Silk EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productHeadingsss">Silk Embroidery</h2>
...
export default SilkEmbroidered;
