...
const CrepePositionPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Crepe Position Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Crepe Position Prints", // Directly filter by "Crepe Position Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Crepe Position Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Crepe Position Prints</h2>
...
export default CrepePositionPrints;
