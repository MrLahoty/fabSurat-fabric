...
import "./SilkEmbroidered.css";

const VelvetEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Velvet Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Velvet Embroidery", // Directly filter by  "Velvet Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Velvet EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productHeadingsss">Velvet Embroidery</h2>
...
export default VelvetEmbroidered;
