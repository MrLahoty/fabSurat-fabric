...
const ViscoseGeorgetteEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Viscose Georgette Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Viscose Georgette Embroidery", // Directly filter by "Viscose Georgette Embroidery" sub-sub-category
        committedRatings
      )
    );
...
export default ViscoseGeorgetteEmbroidered;
