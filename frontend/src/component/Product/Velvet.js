...
const Velvet = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only Velvet sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Velvet", // Directly filter by Velvet sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Velvet PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingsss">Velvet</h2>
