...
const PrintedHakobaFabric = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Printed Hakoba Fabric", // Directly filter by  "Printed Hakoba Fabric" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Printed Hakoba Fabric PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Printed Hakoba Fabric</h2>
...
export default PrintedHakobaFabric;
