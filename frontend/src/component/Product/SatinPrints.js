...
const SatinPrints = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Satin Prints" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Satin Prints", // Directly filter by "Satin Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Satin Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Satin Prints</h2>
