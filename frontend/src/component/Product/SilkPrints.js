  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Silk Prints", // Directly filter by "Silk Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Silk Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Silk Prints</h2>
