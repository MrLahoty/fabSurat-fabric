  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Cotton Prints", // Directly filter by "Chinon Prints" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Cotton Prints PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="producHeadingsss">Cotton Prints</h2>
