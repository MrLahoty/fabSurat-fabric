...
const DyeableHakobaFabric = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Hakoba Fabric", // Sub-category remains "Hakoba Fabric"
        "Dyeable Hakoba Fabric", // Directly filter by  "Dyeable Hakoba Fabric" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Dyeable Hakoba Fabric PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingsss">Dyeable Hakoba Fabric</h2>
...
export default DyeableHakobaFabric;
