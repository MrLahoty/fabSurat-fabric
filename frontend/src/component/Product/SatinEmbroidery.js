  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Satin Embroidery", // Directly filter by "Satin Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Satin EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productHeadingsss">Satin Embroidery</h2>
...
export default SatinEmbroidery;
