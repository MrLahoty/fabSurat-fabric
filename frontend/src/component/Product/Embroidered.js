...
const Embroidered = ({ match }) => {
  ...
  const embroideredSubSubCategories = [
    "Chinon Embroidery",
  ...
  useEffect(() => {
    ...
    // Fetch embroidered products, with optional sub-category filter
    dispatch(
      getProduct(
        keyword,
        currentPage,
        committedPrice,
        "Fabric",
        "Embroidered", // The main category is set to Embroidered
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="productss">
            <h2 className="productsHeadingsss">Embroidered</h2>
            ...
            <div className="subCategory-container">
              ...
              {/* Sub-category List */}
              <ul className={`categoryBoxss ${subCategoriesVisible ? "show" : "hide"}`}>
                {embroideredSubSubCategories.map((subCategory) => (
                  <li
