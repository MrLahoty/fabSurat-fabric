...
const Plain = ({ match }) => {
  ...
  const plainSubSubCategories = 
        ["Hakoba", "Velvet", "Dyeable", "Pure/Viscose", "Others" ]; // Only embroidered sub-categories
  ...
  useEffect(() => {
    ...
    // Fetch Plain products, with optional sub-category filter
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        <>
          ...
          <div className="productss">
            ...
            <div className="subCategory-container">
              ...
              {/* Sub-category List */}
              <ul className={`categoryBoxsss ${subCategoriesVisible ? "show" : "hide"}`}>
                {plainSubSubCategories.map((subCategory) => (
                  <li
