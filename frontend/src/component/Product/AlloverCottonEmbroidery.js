...
const AlloverCottonEmbroidery = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getProduct(
        ...
        "Allover Cotton Embroidery", // Directly filter by  "Allover Cotton Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Allover Cotton Embroidery PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssHeadingoooo">Allover Cotton Embroidery</h2>
...
export default AlloverCottonEmbroidery;
