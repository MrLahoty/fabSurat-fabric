...
const PureViscose = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only ""Pure/Viscose" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Plain", // Sub-category remains "Plain"
        "Pure/Viscose", // Directly filter by "Pure/Viscose" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Pure/Viscose PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productsHeadingsss">Pure/Viscose</h2>
