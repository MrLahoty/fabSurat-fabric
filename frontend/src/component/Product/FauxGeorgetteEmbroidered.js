...
import "./FauxGeorgetteEmbroidered.css";

const FauxGeorgetteEmbroidered = ({ match }) => {
  ...
  useEffect(() => {
    ...
    // Fetch only "Faux Georgette Embroidery" sub-sub-category products
    dispatch(
      getProduct(
        keyword,
        currentPage,
        ...
        "Embroidered", // Sub-category remains "Embroidered"
        "Faux Georgette Embroidery",  // Directly filter by "Faux Georgette Embroidery" sub-sub-category
        committedRatings
      )
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Faux Georgette EMBROIDERED PRODUCTS -- FABSURAT" />
          <div className="productss">
            <h2 className="productssssssHeadingsss">Faux Georgette Embroidery</h2>
...
export default FauxGeorgetteEmbroidered;
