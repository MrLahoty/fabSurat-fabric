...
const Under399 = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(getProduct(keyword, currentPage, [0, 399], category, committedRatings));
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Under 399 Products" />
          <div className="productss">
            <h2 className="productsH">Under ₹399</h2>
