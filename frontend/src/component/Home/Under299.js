...
const Under299 = ({ match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(getProduct(keyword, currentPage, [0, 299], category, committedRatings));
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Under 299 Products" />
          <div className="productss">
            <h2 className="productsH">Under ₹299</h2>
